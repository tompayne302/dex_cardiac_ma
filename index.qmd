...
full_weight_ma_priors <- brms::prior(normal(-0.410, 0.137), coef = "groupdexmedetomidine") +
                brms::prior(normal(0,1), class = b)

ma_full_weight.brm_low_rob <- brm(delirium ~ 0 + Intercept + group,
             data = df,
             family = bernoulli(link = "logit"),
             prior = full_weight_ma_priors,
              iter = 4000,
...
half_weight_ma_priors <- brms::prior(normal(-0.410, 0.137*2), class = b, coef = "groupdexmedetomidine") +
                brms::prior(normal(0,1), class = b)
...
quarter_weight_ma_priors <- brms::prior(normal(-0.410, 0.137*4), class = b, coef = "groupdexmedetomidine") +
                brms::prior(normal(0,1), class = b)
...
vague.brm <- brm(delirium ~ 0 + Intercept + group,
             data = df,
             family = bernoulli(link = "logit"),
             prior = vague_priors,
              iter = 4000,
...
colnames(dat) <- c("Estimate", "95% credible interval", "Group")
